...
<b>Lightmode & Darkmode</b> - Hier werden endlich die CSS-Variablen definiert für die Variante. Wenn ihr beide Felder ausfüllt habt ihr für euer Design automatisch eine dunkle und helle Version. Falls ihr nur eine helle (Light) Version anbieten wollt, dann müsst ihr nur das Lightmode Feld ausfüllen. Für eine dunkle (Dark) Version eben das Feld Darkmode. Es muss auf jeden Fall ein Feld ausgefüllt sein.<br><br>
...
Genau wie bei den anderen zwei Designoptionen wird auch hier wieder mit den Custom properties (CSS-Variablen) gearbeitet und dieses mal mit ganz besonderen. Und zwar mit --accent[Nummer]. Hinter dieser Variable verstecken sich die Farben, welche das Team als Standard bzw die User sich als individuelle Farb festgelegt haben. Das Plugin ist so geschrieben, dass nicht nur eine, sondern mehre Akzentfarben festlegen könnt. In der Reihenfolge wie die Hex-Codes angegeben sind, sind auch die Nummer dann für die CSS-Variablen.<br><br>
<b>Ein Beispiel:</b><br>
...
<b>Theme-ID</b> - Hier werden all eure bisherigen erstellten Themes (Designs) angezeigt. Wählt das entsprechende Theme aus, für welches ihr ein Design mit Akzentfarbe(n) einrichten möchtet. <i>Hinweis:</i> Ich hab die Abfrage der Themes so geschrieben, dass wenn das Design schon bei einem Design mit verschieden Farb-/Headervarianten oder Light-/Darkmodus eingetragen ist nicht nochmal ausgewählt werden kann. Auch wenn es schon zu einem Design mit Akzentfarbe(n) gibt kann es nicht noch einmal ausgewählt werden. Also nicht wundern, wenn dort weniger angezeigt wird.<br><br>

<b>Standardmode</b> - Hier wählt man aus, welches Helligkeitsmodus man als Standard haben möchte. Denn jeder User und jeder Gast, außer es ist was anders eingestellt, wird diesen Modus sehen. <br><br>

<b>Standard-Aktzentfarbe(n)</b> - Hier werden die Standard-Aktzentfarben für das Design eingetragen werden. Ich bin von Hex-Codes ausgegangen, aber es sollte auch mit anderen Angaben funktionieren. Wenn ihr mehre Farben eintragen wollt, dann ist es wichtig, dass zwischen den Farben ein , und Leerzeichen stehen! Sonst wird das später nicht ordentlich gesplittet in der PHP. Wenn ihr normale 7-stellige Hex-Codes für die Farben verwendet, dann können bis zu 55 Farben eingetragen werden. Auch wenn das etwas viel wäre :D <br><br>

<b>Lightmode & Darkmode</b> - Hier werden CSS-Variablen definiert für das Design. Wenn ihr beide Felder ausfüllt habt ihr für euer Design automatisch eine dunkle und helle Version. Falls ihr nur eine helle (Light) Version anbieten wollt, dann müsst ihr nur das Lightmode Feld ausfüllen. Für eine dunkle (Dark) Version eben das Feld Darkmode. Es muss auf jeden Fall ein Feld ausgefüllt sein. Die Variable(n) --accent[Nummer] sollen hier <b>nicht</b> nochmal definiert werden!<br><br>

Auf der Übersichtsseite der Designs mit Akzentfarbe(n) wird der Designname und die entspechende Theme-ID angezeigt. Genauso welche Helligkeitsmöglichkeiten es für das Design gibt und im Falle, dass es ein Light und Darkmodus gibt wird der Standardmodus unterstrichen. Auch werden die Standard-Akzentfarbe(n) aufgelistet.
...
Im Usercp wird je nach Design und Einstellung im ACP der entsprechende Bereich angezeigt. Es gibt drei Teile Light- und Darkmodus, Header-/Farbkombination und individuelle Anpassungen. Wenn ein Light-/Darkmodus für das Design angeboten wird, werden zwei Buttons angezeigt. Ein Button für den Lightmodus und einen für den Darkmodus. Der Button für den schon aktiven Modus ist ausgeblichen und kann nicht angeklickt werden. So wissen die User direkt, welchen Modus sie haben. Sollte es für das Design kein Möglichkeit geben zwischen den zwei Modis zu wählen, so steht dort ein Default Text mit der Angabe, welche Modus vom Team angeboten wird.<br>
...
Bei den individuellen Anpassungen werden bei Designs mit individuellen Aktzentfarben das oder die Input-Felder angezeigt für die Aktzentfarben. Die User bekommen einmal die Standardfarbe angezeigt und wenn sie eine andere Farbe für sich eingetragen haben auch diese angezeigt.
